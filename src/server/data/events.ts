...
export const eventsData: Record<string, Event[]> = {
    "clubs" : [
        {   
            name: "Ellipsis",
            title: "SCIS Day",
            description: "SMU Computing & Information Systems Society, affectionately known as Ellipsis, is the student representative body of the School of Computing & Information Systems (SCIS).",
            date: "20 October",
            time: "12PM to 4PM",
        ...
        },
        {
            ...
            title: "DAP Workshop",
            description: "SMUBIA provides a space for connecting students, alumni and institutions who are passionate about data analytics and business intelligence. As we integrate ourselves into the Information Age, data analytics has become an indispensable tool in our lives.",
            date: "21 October",
            time: "12PM to 4PM",
            venue: "SR 4-2",
        },
        ...
        },
        {
            ...
            description: "SMU's Indian Cultural Society presents a chance to connect with its accomplished alumni across various sectors, including Finance, Consulting, Operations, Information Technology, Human Resources, and Accounting.",
            date: "19 October",
            time: "4PM - 6PM",
            venue: "SOL SR 2-4",
          },
