...
Files: ernest_room.glb [2.33MB] > C:\Users\ernes\Desktop\School\WAD2\study-room\source\ernest_room-transformed.glb [176.08KB] (92%)
*/
...
export function Ernest_room(props: JSX.IntrinsicElements["group"]) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      />
      <mesh
        geometry={nodes.Pack_White.geometry}
        material={materials.White}
        position={[2.892, -0.144, -2.887]}
        rotation={[0, -0.96, 0]}
        scale={0.2}
      />
    </group>
