...
export const years = [EXEMPTION_YEAR, "1", "2", "3", "4", "5"] as const;
...
export type Planner = Record<
  Exclude<Year, typeof EXEMPTION_YEAR>,
  Record<Exclude<Term, typeof EXEMPTION_TERM>, PlannerModuleInfo[]>
> & {
